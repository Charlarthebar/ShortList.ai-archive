...
# Paths (all mvp folders are now siblings within mvp/)
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
MVP_ROOT = os.path.dirname(os.path.dirname(SCRIPT_DIR))  # Goes to mvp/
ONET_SKILLS_PATH = os.path.join(MVP_ROOT, "Charlie's Work", "onet_skills.csv")
CAMBRIDGE_JOBS_PATH = os.path.join(MVP_ROOT, "Charlie's Work", "cambridge_jobs.csv")
